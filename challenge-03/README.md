...
*/
let pessoa={nome:'Ana', sobrenome:'Maria', sexo:'feminino', idade:15 ,altura:1.54, peso:50, andando:false, caminhouQuantosMetros:0}
...
return 'Mina altura é + pessoal.altura+'m';
}
