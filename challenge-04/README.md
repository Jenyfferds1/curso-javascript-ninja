...
*/
let carro= {marca:'audi', modelo:'sedan', placa:'ABC-1234',
...ano:2019, cor:'branco', quantasPortas:4, assentos:5, quantidadePessoas:0};
...
INVOCAR: carro.mudaCor('vermelho')
